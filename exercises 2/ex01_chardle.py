...
if chosen_word[0] == single_character:
    print(single_character + " was found at index 1")
    count = count + 1
if chosen_word[1] == single_character:
    print(single_character + " was found at index 2")
    count = count + 1
if chosen_word[2] == single_character:
    print(single_character + " was found at index 3")
    count = count + 1
if chosen_word[3] == single_character:
    print(single_character + " was found at index 4")
    count = count + 1
if chosen_word[4] == single_character:
    print(single_character + " was found at index 5")
    count = count + 1
