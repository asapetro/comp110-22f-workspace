...
# Declaring a type alieas that "invents" the Ppoint2D type
...
# An example of using the defaukt parameter step
# where the default step is 1 
another_range: range = range(0, 10)

# if you only pass one argument to range, it speciies
...
names: list[str] = ["kris", "ben", "arnold", "alyssa"]
